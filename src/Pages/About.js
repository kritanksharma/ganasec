...
export default function About() {
  ...
  const teamSection1 = {
    ...
    description0: "At GanaSec, our founders, Ashish K and Subhajit Saha, bring a wealth of experience and passion to the table. Both are seasoned bug bounty hunters and security engineers who know the field inside and out." ,
    description1:
