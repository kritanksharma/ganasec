        ...
        <div className="row g-0 align-items-center p-4">
          <div className="col-md-6">
            <div className="card-body p-3">
              ...
              <h3 className="text-start fw-bold display-4 text-secondary-emphasis">{reports.title}</h3>
              <p className="card-text mt-2 fs-6 content-to-animate text-secondary" style={{ textAlign: "justify" }}>
                {reports.description}
              </p>
            </div>
          </div>
              ...
              <div className="card text-start bg-light shadow-lg overflow-hidden p-2 pt-4">
                <div className="card-body p-2">
                  {reports.block.points.map((point, index) => (
                    <p key={index}>
                      <Icon className="mx-1" path={reports.block.pointIcon} size={1} color="#50C878" />
